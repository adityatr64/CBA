...
/*  cpsr, sp, lr, pc: These are special registers:
    cpsr: The Current Program Status Register. It contains flags that control the CPU's state (e.g.,
   N, Z, C, V flags). sp: The Stack Pointer. It points to the top of the stack in memory. lr: The
   Link Register. It stores the return address when a function is called. pc: The Program Counter.
   It stores the address of the next inst to be executed.
*/
...
class CPU {
 ...
 public:
  ...
  void executeArmMultiply(uint32_t inst);
